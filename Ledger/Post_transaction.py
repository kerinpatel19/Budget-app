...
class Add_Transaction:
    ...
    def Add_Transaction(cls, db_host, db_user, db_password, database_name, TransactionDate, Account, Note, Amount, Category):
        ...
        insert_data_query = f"""
            INSERT INTO {table_name} (TransactionDate, Account, Note, Amount, Category) 
            VALUES (%s, %s, %s, %s, %s)
            """

        data = (TransactionDate, Account,Note, Amount, Category)
