...
class Add_Expense:
    ...
    def Add_expense(cls, db_host, db_user, db_password, db_name, Expense_date, note, amount, Category):
        ...
        if row is not None:
            ...
            try:
                ...
                post_transaction.Add_Transaction(db_host, db_user, db_password, db_name, Expense_date, "Checking_Account", note, amount, Category)
